...
SECRET_KEY = 'django-insecure-sv^_&5lm!5@k-yqgcra+@ch8_k4d!52rtho=cg8pn(wv6$t6_v'
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "marlond-leanderd-soco-footballshop.pbp.cs.ui.ac.id", "10.0.2.2"]
